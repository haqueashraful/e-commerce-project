...
const DetailsPage = ({ params }) => {
    ...
    useEffect(() => {
        ...
        fetchDataFormApi(`/api/products/${params.productId}`).then((res) => {
                    ...
                    <div className='breadcrumbWrapper mb-4'>
                        <div className='container-fluid'>
                            <ul className="breadcrumb breadcrumb2 mb-0">
                                ...
                                <li><Link href={`/category/${prodCat.parentCat.split(' ').join('-').toLowerCase()}`}
                                ...
                                <li><Link href={`/category/${prodCat.parentCat.toLowerCase()}/${prodCat.subCatName.replace(/\s/g, '-').toLowerCase()}`}
